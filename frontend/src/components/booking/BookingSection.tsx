...
import { showBookingConfirmationNotification } from '../../utils/notifications';
...
export default function BookingSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Show browser notification (additive — does not affect on-page confirmation)
      showBookingConfirmationNotification(formData.mobileNumber);
